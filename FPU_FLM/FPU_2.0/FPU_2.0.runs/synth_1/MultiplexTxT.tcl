...
synth_design -top MultiplexTxT -part xc7a100tcsg324-1
write_checkpoint -noxdef MultiplexTxT.dcp
catch { report_utilization -file MultiplexTxT_utilization_synth.rpt -pb MultiplexTxT_utilization_synth.pb }
