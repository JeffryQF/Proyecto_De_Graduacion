...
HD_PWD='/media/francis/Acer/Users/Francis/Documents/GitHub/Proyecto_De_Graduacion/Proyecto_version_inicial_Diego/Iteracion 1/Iteracion 1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FPU_Multiplication_Function.vdi -applog -m64 -messageDb vivado.pb -mode batch -source FPU_Multiplication_Function.tcl -notrace
