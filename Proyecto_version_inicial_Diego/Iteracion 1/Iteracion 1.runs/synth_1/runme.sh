...
HD_PWD='/media/francis/Acer/Users/Francis/Documents/GitHub/Proyecto_De_Graduacion/Proyecto_version_inicial_Diego/Iteracion 1/Iteracion 1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Temporal_op_result_sign.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Temporal_op_result_sign.tcl
