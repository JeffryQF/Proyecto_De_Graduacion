...
\newcommand{\scriptAuthor}{Jeffry Ignacio Quirós Fallas}

% Título de la tesis
\newcommand{\scriptTitle}{Diseño e Implementación de una Unidad de Punto Flotante FPU.} 

% Keywords
\newcommand{\scriptKeywords}{CORDIC, seno, coseno, FPU, precisión simple, precisión doble, FPGA}
\newcommand{\scriptKeywordsEnglish}{CORDIC, sine, cosine, FPU, simple precision, double precision, FPGA}
