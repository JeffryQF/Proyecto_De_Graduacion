...
El algoritmo originalmente propuesto \cite{CORDIC}, describe la rotación de un vector bidimensional en el plano cartesiano. El funcionamiento del algoritmo se deduce de la formula general de rotación de vectores:

\begin{eqnarray}
x^{\prime} = xcos \theta - ysen \theta \\
y^{\prime} = ycos \theta + xsen \theta
\end{eqnarray}\label{eq:ec_rot_vectores}
